...
public class LoadCompanies extends LoadOntology {
	...
	// date datatype may be needed in stock
	// undone
...
//Stock missing 
	...
	public static void main (String [] args)
	{
		...
		//ReturnonAssets	RevenuePerShare		TotalCashPerShare	TotalDebtEquity			Date		Open	High	Low			Close		Volume		Adj_Close
		//13.28				48.22				4.21				45.38					2015-01-23	165.75	165.98	163.91		164.02		2245600		164.02
		
		// String symbol, String name, String country, Integer iPOyear, String sector, String industry, String summary, Integer enterpriseValue, Integer prices, Float returnonAssets,
		// Float revenuePerShare, Float totalCashPerShare, Float totalDebtEquity)
